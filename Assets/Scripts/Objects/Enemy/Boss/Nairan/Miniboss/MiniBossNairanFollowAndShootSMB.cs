...
public class MiniBossNairanFollowAndShootSMB : AbsFollowAndShootSMB
{
    ...
    {
        MiniBossNairanCtrl.Instance.MinibossNairanModelShipAnimation.SetIsFollowAndShoot(isOn);
        MiniBossNairanCtrl.Instance.MinibossNairanShootNormal.SetIsFiring(isOn);
    }
